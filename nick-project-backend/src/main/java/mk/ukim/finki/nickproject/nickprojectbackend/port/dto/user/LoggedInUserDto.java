...
import mk.ukim.finki.nickproject.nickprojectbackend.domain.model.user.CommentNotification;
import mk.ukim.finki.nickproject.nickprojectbackend.domain.model.user.FriendRequest;
import mk.ukim.finki.nickproject.nickprojectbackend.domain.model.user.LikeNotification;
...
public class LoggedInUserDto implements Serializable {
    ...
    private final Set<FriendRequest> sentFriendRequests;

    private final Set<FriendRequest> receivedFriendRequests;

    private final Set<LikeNotification> likeNotifications;

    private final Set<CommentNotification> commentNotifications;
    ...
    public LoggedInUserDto(User user) {
        ...
        this.likeNotifications = user.getLikeNotifications();
        this.commentNotifications = user.getCommentNotifications();
    }
